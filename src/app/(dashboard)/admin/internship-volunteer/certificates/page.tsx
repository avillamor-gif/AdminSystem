        ...
        <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', gap: 8 }}>
          ...
          <div style={{ textAlign: 'center', flex: 1, minWidth: 0 }}>
            {deptHeadSig && (
              ...
              <img src={deptHeadSig} alt="Department Head signature" style={{ height: 48, objectFit: 'contain', display: 'block', marginLeft: 'auto', marginRight: 'auto', position: 'relative', top: 12 }} />
            )}
          ...
          <div style={{ textAlign: 'center', flex: 1, minWidth: 0 }}>
            {coordinatorSig && (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={coordinatorSig} alt="Coordinator signature" style={{ height: 48, objectFit: 'contain', display: 'block', marginLeft: 'auto', marginRight: 'auto', position: 'relative', top: 12 }} />
            )}
            <div style={{ fontSize: 10, fontWeight: 600, marginBottom: 4, lineHeight: 1.2, wordBreak: 'break-word', marginTop: 8 }}>
              {coordinatorName}
            </div>
          ...
          <div style={{ textAlign: 'center', flex: 1, minWidth: 0 }}>
            {edSig && (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={edSig} alt="Executive Director signature" style={{ height: 48, objectFit: 'contain', display: 'block', marginLeft: 'auto', marginRight: 'auto', position: 'relative', top: 12 }} />
            )}
            <div style={{ fontSize: 10, fontWeight: 600, marginBottom: 4, lineHeight: 1.2, wordBreak: 'break-word', marginTop: 8 }}>
