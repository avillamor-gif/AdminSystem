                  ...
                  return (
                    <tr key={req.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize ${priorityBadge[req.priority] || 'bg-gray-100 text-gray-600'}`}
                        >
                          {req.priority}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize ${statusBadge[req.status] || 'bg-gray-100 text-gray-600'}`}
                        >
                          {req.status}
                        </span>
                      </td>
