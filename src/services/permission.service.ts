  ...
  getDefaultPermissionsByRole(role: string): string[] {
    ...
    const rolePermissions: Record<string, string[]> = {
      ...
      'ed': [
        ...
        'nav.attendance', 'nav.directory', 'nav.equipment', 'nav.leave',
        'nav.my_info', 'nav.performance', 'nav.publications', 'nav.supplies', 'nav.travel',
        'org.manage', 'org.view',
      ...
      'admin': [
        ...
        'equipment.approve', 'equipment.create', 'equipment.manage', 'equipment.view',
        'governance.view', 'governance.manage', 'governance.board.manage', 'governance.assemblies.manage', 'governance.export',
        'jobs.manage', 'jobs.view',
        ...
        'learning.manage', 'learning.view',
        'membership.view', 'membership.manage', 'membership.applications.review', 'membership.dues.manage', 'membership.campaigns.manage', 'membership.export',
        'my_info.edit', 'my_info.view',
        'nav.attendance', 'nav.directory', 'nav.equipment', 'nav.governance', 'nav.leave', 'nav.membership',
        'nav.my_info', 'nav.performance', 'nav.publications', 'nav.supplies', 'nav.travel',
        'org.manage', 'org.view',
        'performance.conduct', 'performance.manage_goals', 'performance.view',
        'internship.manage',
      ...
      'hr': [
        ...
        'leave.manage_balance', 'leave.manage_types', 'leave.reject', 'leave.view',
        'learning.manage', 'learning.view',
        'membership.view', 'membership.manage', 'membership.applications.review', 'membership.dues.manage', 'membership.export',
        'my_info.edit', 'my_info.view',
        'nav.attendance', 'nav.directory', 'nav.equipment', 'nav.governance', 'nav.leave', 'nav.membership',
        'nav.my_info', 'nav.performance', 'nav.publications', 'nav.supplies', 'nav.travel',
        'org.manage', 'org.view',
      ...
      'employee': [
        ...
        'my_info.edit', 'my_info.view',
        'nav.attendance', 'nav.directory', 'nav.equipment', 'nav.leave',
        'nav.my_info', 'nav.publications', 'nav.supplies', 'nav.travel',
        'publications.request', 'publications.view',
        'supplies.view',
      ...
      'board member': [
        ...
        'employees.view',
        'leave.view',
        'nav.directory', 'nav.my_info', 'nav.performance',
        'org.view',
        'performance.view',
        'reports.view',
      ],
