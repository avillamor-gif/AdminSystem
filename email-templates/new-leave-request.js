/**
 * NEW LEAVE REQUEST EMAIL TEMPLATE
 * 
 * Sent to supervisors/admins when an employee submits a new leave request.
 * 
 * Usage:
 * import { newLeaveRequestEmail } from '@/lib/emailTemplates'
...
function newLeaveRequestEmail(opts) {
...
if (typeof module !== 'undefined') {
  module.exports = { newLeaveRequestEmail }
}
