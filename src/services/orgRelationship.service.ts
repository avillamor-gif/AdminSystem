...
export type OrgRelationship = Database['public']['Tables']['org_relationships']['Row']
export type OrgRelationshipInsert = Database['public']['Tables']['org_relationships']['Insert']
export type OrgRelationshipUpdate = Database['public']['Tables']['org_relationships']['Update']
