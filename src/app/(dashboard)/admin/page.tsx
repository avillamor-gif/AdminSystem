...
export default function AdminPage() {
  ...
  const allAdminModules = [
    ...
    },
    {
      ...
      description: 'Manage asset inventory, long-term assignments, maintenance, and depreciation',
      icon: Package,
      color: 'bg-slate-600',
      href: '/admin/asset-management',
      items: ['Assets', 'Assignments', 'Maintenance', 'Setup', 'Reports'],
      requiresPermission: 'admin.assets',
    },
    {
      id: 'office-equipment',
      title: 'Office Equipment',
      description: 'Approve equipment borrow requests and track active loans',
      icon: Monitor,
      color: 'bg-cyan-600',
