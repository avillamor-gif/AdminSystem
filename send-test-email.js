...
async function sendTestEmail() {
  ...
  try {
    ...
    console.log('From: II Admin System <noreply@adminsystem.iboninternational.org>')
    console.log('To: avillamor@iboninternational.org\n')
    ...
    console.log('\n📬 Check your inbox at: avillamor@iboninternational.org')
    console.log('\n📧 Email includes:')
    console.log('  • Orange II Admin System branding')
    console.log('  • Leave request details table')
    console.log('  • "Review Request →" button linking to admin panel')
  } catch (error) {
