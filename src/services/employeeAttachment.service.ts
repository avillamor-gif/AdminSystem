...
// Manual type — employee_attachments was added via migration after last db:types run
...
export type EmployeeAttachmentInsert = Omit<EmployeeAttachment, 'id' | 'created_at' | 'updated_at' | 'uploaded_at'>
