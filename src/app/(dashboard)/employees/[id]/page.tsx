  ...
  const handleEmploymentSave = async () => {
    ...
    try {
      ...
      const cleanData = {
        ...
        status: employmentFormData.status || 'active',
                    ...
                    <input
                      ...
                      onChange={async (e) => {
                        ...
                        console.log('📤 Starting attachment upload:', {
                          ...
                          uploadedBy: roleInfo?.employee_id
                        })
                      ...
                      {isLoadingAttachments ? (
                        ...
                        employeeAttachments.map((attachment) => (
                          <tr key={attachment.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 text-sm text-gray-600">{formatDate(attachment.created_at)}</td>
                            <td className="px-4 py-3 text-sm text-gray-600">
                          ...
                          <td className="px-4 py-3 text-sm">
                            <div className="flex items-center gap-2">
                              <button
                                onClick={async () => {
                                  try {
                                    const blob = await downloadEmployeeAttachment.mutateAsync({
                                      filePath: attachment.file_path,
                                      fileName: attachment.file_name
                                    })
...
export default function EmployeeDetailPage() {
  return <EmployeeDetailContent backHref="/employees" />
}
